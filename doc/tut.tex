...
\usepackage{fancyhdr,fancybox,longtable}
\usepackage{times}
...
\psfig{figure=montage/montage.eps,width=12cm}
\vspace*{2cm}
{\Afon (Release 8)}\hfill\psfig{figure=figs/lgplv3-147x51.eps,width=2cm}                             %% CHANGE

\vspace*{\fill}
\hrule
\parbox{50mm}{{\Afon Peter I. Corke}\\
Peter.I.Corke@gmail.com} \hfill {\Afon December 2008}\\    %% CHANGE
...
%2002\\
%http://www.ict.csiro.au/staff/Peter.Corke
%\end{Bflushleft}}
%\vspace*{\fill}

\copyright 2008 by Peter I. Corke.                  %% CHANGE
\noindent
\cleardoublepage
...
This, the eighth release of the Toolbox, represents nearly a decade of %% CHANGE
